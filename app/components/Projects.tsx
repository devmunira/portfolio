      ...
      >
        {data?.projects?.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="h-[500px] box-border flex mobile:flex-col laptop:flex-row justify-between items-center relative w-full py-10 bg-primary-100 p-10 rounded-md">
